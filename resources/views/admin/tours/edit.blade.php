...
<form autocomplete="off" role="form" style="width:100%" id="spot-form" method="POST" action="{{ url('/tours/'.$tour->id)}}" enctype="multipart/form-data">  
  <div class="row">
          ...
          <div class="form-group">
                ...
                <select name="itinerary_id" id="itinerary_id" class="form-control custom-select">
                    ...
                    @foreach ($itineraries_list as $key => $item)
                        @if($key == old('itinerary_id',$tour->itinerary_id))
            ...
            <div class="form-group">
                ...
                <select name="ship_id" id="ship_id" class="form-control custom-select">
                    ...
                    @foreach ($ships_list as $key => $item)
                        @if($key == old('ship_id',$tour->ship_id))
                          <option selected="selected" value="{{ $key }}">{{ $item }}</option>
                        @else
                          <option value="{{ $key }}">{{ $item }}</option>
                        @endif
            ...
            <div class="form-group">
              ...
              <input type="text" name="title" id="title" placeholder="8 days East Carabian" class="form-control" value="{{ old('title',$tour->title) }}">
              @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea name="details" id="details" class="form-control" rows="4">{{ old('details',$tour->details) }}</textarea>
            ...
            <div class="form-group">
              ...
              <input type="text" name="start_date" id="start_date" placeholder="Start Date" class="form-control" value="{{ old('start_date',$tour->start_date) }}">
            ...
            <div class="form-group">
              ...
              <input type="text" name="end_date" id="end_date" placeholder="Start Date" class="form-control" value="{{ old('end_date',$tour->end_date) }}">
            ...
            <div class="form-group">              
              ...
              <input type="text" name="nights" id="nights" placeholder="8" class="form-control" value="{{ old('nights',$tour->nights) }}">
            ...
            <div class="form-check">
                ...
                @else
                <input type="checkbox" value="1" name="available" class="form-check-input" id="available">
                @endif
            ...
            <div class="form-check">
                @if($tour->on_hold)
                <input type="checkbox" value="1" checked name="on_hold" class="form-check-input" id="on_hold">
                @else
            ...
            <div class="form-group">              
              ...
              <input type="text" name="current_gross_rate" id="current_gross_rate" placeholder="60" class="form-control" value="{{ old('current_gross_rate',$tour->current_gross_rate) }}">
            ...
            <div class="form-group">              
              ...
              <input type="text" name="original_gross_rate" id="original_gross_rate" placeholder="60" class="form-control" value="{{ old('original_gross_rate',$tour->original_gross_rate) }}">
            ...
            <div class="form-group">              
              <label for="original_net_rate">Current Net Rate</label>
              <input type="text" name="current_net_rate" id="current_net_rate" placeholder="60" class="form-control" value="{{ old('current_net_rate',$tour->current_net_rate) }}">
            ...
            <div class="form-group">              
              ...
              <input type="text" name="original_net_rate" id="original_net_rate" placeholder="60" class="form-control" value="{{ old('original_net_rate',$tour->original_net_rate) }}">
              @if($errors->has('original_net_rate'))
            ...
            <div class="form-group">              
              ...
              <input type="text" name="promotion" id="promotion" placeholder="Promotion like 10% off" class="form-control" value="{{ old('promotion',$tour->promotion) }}">
