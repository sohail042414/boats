            ...
            <div class="row">
              <div class="col-md-6 col-lg-6 col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="length" id="length" class="form-control" value="{{ old('length',$ship->length) }}">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="beam" id="beam" class="form-control" value="{{ old('beam',$ship->beam) }}">
                  @if($errors->has('beam'))
              ...
              <div class="col-md-6 col-lg-6 col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="engines" id="engines" class="form-control" value="{{ old('engines',$ship->engines) }}">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="draft" id="draft" class="form-control" value="{{ old('draft',$ship->draft) }}">
                  @if($errors->has('draft'))
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="gross_tonnage" id="gross-tonnage" class="form-control" value="{{ old('gross_tonnage',$ship->gross_tonnage) }}">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="electricity" id="electricity" class="form-control" value="{{ old('electricity',$ship->electricity) }}">
