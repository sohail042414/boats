...
<form autocomplete="off" role="form" style="width:100%" id="ship-form" method="POST" action="{{ url('/animals')}}">  
  <div class="row">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" name="name" id="name" placeholder="Animal/Bird Name" class="form-control" value="{{ old('name','') }}">
              @if($errors->has('name'))
