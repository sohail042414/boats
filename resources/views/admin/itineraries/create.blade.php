...
<form autocomplete="off" role="form" style="width:100%" id="ship-form" method="POST" action="{{ url('/itineraries')}}">  
  <div class="row">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" name="code" id="code" placeholder="Itinerary Code like A2" class="form-control" value="{{ old('code','') }}">
              @if($errors->has('code'))
            ...
            <div class="form-group">
              ...
              <input type="text" name="title" id="title" placeholder="Itinerary Title" class="form-control" value="{{ old('title','') }}">
              @if($errors->has('code'))
                    <span style="display:block;" class="error invalid-feedback"> {{ $errors->first('code') }}</span>
              @endif
            </div>
            ...
            <div class="form-group">
                ...
                <select name="spots[]" id="island_id" multiple="true" class="form-control select2">
