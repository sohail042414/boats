...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Itineraries</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<!-- /.content-header -->
        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
          <div class="card card-primary">
            <div class="card-header">
              <a href="{{ url('/itineraries/create') }}" class="btn btn-success">Add New</a>            
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="itineraries-table" class="table table-bordered table-hover">
                <thead>
                <tr>
                  <th>Actions</th>
                  <th>Id</th>
    ...
    function deleteTableRow(obj){
      ...
      $.ajax({
          ...
          success: function(response) {
            ...
            $('#itineraries-table').DataTable().rows().invalidate('data').draw(false);
          }
      });
    }
    ...
    function editTableRow(obj){          
          var row_id = $(obj).attr('data-row'); 
          window.location.href = '/itineraries/'+row_id+'/edit';
      }
